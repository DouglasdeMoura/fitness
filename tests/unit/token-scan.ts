...
const HEX_ALLOWLIST: Array<{ file: string; pattern: RegExp }> = [
  {
...
function countRuleViolations(lines: string[], rule: TokenRule, filePath: string): number {
...
export function scanTokenViolations(projectRoot = process.cwd()): TokenScanResult {
