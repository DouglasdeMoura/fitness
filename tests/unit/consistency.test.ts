...
describe('logAdherence', () => {
  ...
  it('handles timezone-boundary dates via local noon math', () => {
    ...
    expect(buildLast7Days(dates, '2020-01-01').map((day) => day.date)).toContain('2019-12-31')
  })
})
...
describe('currentStreak', () => {
  ...
  it('breaks when a day is missed without grace', () => {
    expect(currentStreak(['2020-01-01', '2020-01-07'], 0, '2020-01-07')).toBe(1)
  })
...
describe('longestStreak', () => {
  ...
  it('finds the longest consecutive run across gaps', () => {
    const dates = ['2020-01-01', '2020-01-02', '2020-01-05', '2020-01-06', '2020-01-07']
