...
test.describe('Weekly review (issue #64)', () => {
  ...
  test('dashboard entry appears only when a complete review week has activity', async ({ page }) => {
  ...
  test('review page renders adherence, volume delta, weight trend, and PRs', async ({ page }) => {
    seedReviewWeekActivity()
