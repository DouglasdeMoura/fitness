...
/**
 * fittrack-neutral theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { fittrackNeutralTheme } from './fittrack-neutral';
 *   import './fittrack-neutral.css';
 */
export const fittrackNeutralTheme = {
  ...
  tokens: {
    ...
    "--color-icon-secondary": "light-dark(#525252, #a3a3a3)",
